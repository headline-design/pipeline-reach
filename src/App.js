...
class App extends Component {
  ...
  async vote() {
    ...
    let txn = algosdk.makeApplicationNoOpTxn(sender, params, parseInt(document.getElementById("optid").value), appArgs)
        ...
        <table><thead></thead><tbody>
          <tr className="breakpoint-1" ><td valign="top" className="module-left"><p className="prop-label">Dev Environment</p>
            ...
            <td valign="top" className="module-right">
              ...
              <textarea style={{ "backgroundColor": "black", "color": "yellow", "width": "100%" }} id="log" readOnly rows="21" cols="50">
              </textarea>
              <br></br><br></br>
